...
* 주요 전처리 내용은 다음과 같음
  * **기관명 및 주소 정보**
    <p>본 프로젝트에서는 동일 지역 내 병원 간 의료이익을 비교하는 지도 시각화를 수행하고자 함<br>수정한 주소 정보와 공간산업진흥원의 Geocoder API를 활용, 위도 및 경도 데이터를 추가 수집함</p>
    <p></p>
    
    * **동일한 주소의 기관명이 연도별로 다른 경우 최근 기준으로 통일**
      <p>예) 경상남도 진주시 강남로 79에 위치한 상급종합병원의 이름을 아래와 같이 변경</p>
      <table>
       <tr>
    ...
    * **동일한 기관의 주소가 연도별로 다른 경우 최근 기준으로 통일**
      <p>예) 연세대학교 의과대학 용인세브란스병원의 주소 정보를 최신 기준으로 통일</p>
      <table>
       <tr>
        <th align ='center'>연도</th>
  ...
  * **컬럼명 수정**
    <p>회계 데이터에서 상위 계정과 하위 계정간의 관계를 바로 파악할 수 있도록 컬럼명을 수정함</p>
...
* 대시보드는 각 항목별로 아래와 같은 정보를 제공함
  ...
  1. **지역(시도, 시군구) 내 병원 간 의료이익 비교**
     <p>상단의 시도, 시군구를 선택했을 때, 선택 지역 병원의 의료이익을 원의 색상, 크기로 비교할 수 있음<br>예) 경기도 고양시에는 6곳의 (상급)종합병원이 있고 인제대학교 일산백병원의 의료이익이 가장 큼</p>
  2. **의료수익경상이익률 비교**
     <p>기관명을 선택했을 때, 해당 기관의 의료이익경상이익률을 동급 평균과 비교할 수 있음<br>최근 대형 병원의 새 먹거리로 떠오른 연구 수익 등 기타 매출 사항을 해당 지표로 가늠할 수 있음</p>
     <p>관련 기사 : <a href ='http://www.doctorstimes.com/news/articleView.html?idxno=222697'>"연구 수익으로 진료에 투자"··· 고대의료원, '초격차 연구중심 도약'</a></p>
  3. **연도별 의료이익률 추이**
     <p>기관명을 선택했을 때, 2019 - 21 회계연도 해당 기관의 의료이익률 증감을 확인할 수 있음<br>0을 기준으로 선의 색깔이 달라지고, 절대값에 따라 두께가 변하기 때문에 쉽게 이해할 수 있음</p>
  4. **2021 회계연도 의료수익 대비 비용 비교**
     <p>기관명을 선택했을 때, 2021 회계연도 의료수익 대비 인건비/재료비/관리운영비를 확인할 수 있음<br>의료수익 대비 비용이 동급 평균에 비해 높으면 편차를 적색으로 표시해 개선 필요성을 부각함<br>예) 국립암센터의 의료수익 대비 재료비는 40%로 동급 평균 25%에 비해 15%p 가량 높아 개선 필요</p>
---
### ④ 향후 진행 계획
